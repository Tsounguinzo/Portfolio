 ...
 *   npm run seed
 * 
 * Make sure MONGODB_URI is set in your .env or .env.local
 */
...
const experiences = [
  ...
  },
  {
    ...
    description: "Developed high throughput data sync layer and closure service for Autodesk data platform.",
  ...
  },
  {
    ...
    description: "Teaching assistant for Object-Oriented Programming, Data Structures and Algorithms courses and Web Development courses.",
  ...
  },
  {
    ...
    description: "Developed and deployed a new design for the visibility toolkit. Implementing undo/redo throughout the design workflow.",
  ...
  },
  {
    ...
    description: "Created test case generation tool which creates random XML docs from XML Schema. Implementing tooth tagging from AI tooth segmentation data.",
    link: "https://straumann.com",
    images: [],
  },
];
...
const profile = {
  ...
  socials: [
    { name: "Github", link: "https://github.com/Tsounguinzo", icon: "github" },
    { name: "LinkedIn", link: "https://www.linkedin.com/in/beaudelaire", icon: "linkedin" },
    { name: "Instagram", link: "https://www.instagram.com/beaudelaire001", icon: "instagram" },
  ],
};
...
const recommendations = [
  {
    ...
    message: "Beaudelaire is an amazing teammate. He's always there when you need help, ready to share his resources and knowledge without hesitation. It's clear he genuinely cares about others' success. Beyond his smarts, he has this warm, friendly vibe that makes every group project feel more enjoyable. I'm grateful to have him as a teammate and study buddy!",
  },
  {
    ...
    message: "J'ai été très impressionnée par le niveau d'implication et d'aptitude de Beaudelaire tout au long de son stage. Il apprend vite et a bien contribué dans un ensemble varié de tâches au sein de notre équipe. C'est pourquoi je le recommande sans hésitation!",
  },
  {
    ...
    message: "Beaudelaire has been a great colleague who doesn't hesitate to ask questions and to take on difficult tasks. His general knowledge of Java is very good and he can work independently quite well. It is a pleasure to work with him.",
  },
  {
    name: "Yvan Luu",
    ...
    message: "Beaudelaire is eager to learn and take on challenges. Despite being a newer addition to our team, he isn't afraid to take tasks outside his comfort zone and complete them in a satisfactory manner.",
  },
  {
    ...
    message: "Beaudelaire is a committed professional that jumps right into the action. When a new task arrives, he doesn't hesitate to take it even if it's out of his comfort zone. He takes every new task as an opportunity to learn and strengthen his abilities. He is also a kind person, receptive to critics and hard working.",
  },
  {
    name: "Zhengxuan Zhao",
    ...
    message: "Working with Beaudelaire Tsoungui Nzodoumkouo on the Concordia.course website project was an exceptional experience, even though it's a short period. His coding expertise and problem-tackling approach significantly contributed to the project. He is a consistent and steady coder, delivering high-quality code almost every day! His strong analytical skills and attention to detail played important roles when we were reviewing every commit. It was a great experience for me as I learned a lot from him. One more thing! Check out our work @ https://concordia.courses and see for yourself! 🚀",
  },
  {
...
async function seed() {
  ...
  try {
    ...
    await collection.insertOne(portfolioDoc);
